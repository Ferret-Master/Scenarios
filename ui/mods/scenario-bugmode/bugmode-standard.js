...
model.objectiveCheckFunctions["bug_mode_base"] = function (waveObject){
    ...
    if(bug_standard.creepPoints.length<1 && bug_standard.startComplete == false && model.scenarioModel.RealTimeSinceLanding > 5){bug_standard.updateDontSpawnPoints();bug_standard.spawnStartingBugBase(2);_.delay(bug_standard.spawnSpire(5000));return 10}
